...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8343227097:AAHFstPw3KJGPekcvNwemB6SOCbvf6Pi4oI")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003273518766"))
...
#Database --⚠️ REQUIRED--
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://hurryapurrya:KcRXeLz4N21gcN7F@cluster0.bwp3hkb.mongodb.net/?appName=MuzanXebot")
DB_NAME = os.environ.get("DATABASE_NAME", "MuzanXe_bot")

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#Collection of pics for Bot // #Optional but atleast one pic link should be replaced if you don't want predefined links
PICS = (os.environ.get("PICS", "https://graph.org/file/d7dc886b51feb2ecd169f-313a08a0df20cb3961.png")).split() #Required
